...
/* Use the spread operator to create a copy of the product object below.  
Name the copy "productCopy" */
...
/* Using the spread operator, concatentate the two arrays below and save it to a variable 
named "combinedArrays" */
